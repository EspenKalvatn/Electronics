...
int buttonToPinMap[10] = {2, 3, 4, 5, 6, 8, 9, 10, 11, 12};
...
void loop()
{
    ...
    for (int buttonIndex = 0; buttonIndex < 10; buttonIndex++)
    {
        ...
        { // Checks if the current state is different from the last registered state.
            switch (buttonIndex)
            {       // Finds the right button to change (according to the button index).
            case 0: // Up (gamepad)
